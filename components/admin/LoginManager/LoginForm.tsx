  ...
  return (
    <div className="w-full max-w-md relative z-10">
      <div className="bg-zinc-900/50 backdrop-blur-xl border border-zinc-800/50 rounded-2xl shadow-2xl overflow-hidden">
        <div className="bg-gradient-to-r from-gsw/10 via-purple-600/10 to-gsw/10 border-b border-zinc-800/50 p-8 text-center">
        ...
        <div className="p-8">
          <form onSubmit={handleLogin} noValidate className="space-y-5">
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center px-1">
                ...
                <button 
                  ...
                  className="text-[10px] font-bold text-gsw hover:text-purple-400 uppercase tracking-tighter transition-colors"
                >
                  Esqueceu a senha?
                </button>
              </div>
            ...
            {error && (
              <div className="bg-red-900/20 border border-red-500/30 text-red-400 px-4 py-3 rounded-xl text-sm flex items-start gap-3 animate-in fade-in slide-in-from-top-2 duration-300">
            ...
            <button 
              type="submit" 
              disabled={loading} 
              className="w-full bg-gradient-to-r from-gsw to-purple-600 hover:from-purple-600 hover:to-gsw disabled:opacity-50 disabled:cursor-not-allowed text-white font-black text-sm uppercase tracking-wider py-4 rounded-xl transition-all shadow-lg shadow-gsw/30 hover:shadow-gsw/50 active:scale-[0.98] flex items-center justify-center gap-3"
            >
              {loading ? (
        ...
        <div className="bg-zinc-950/50 border-t border-zinc-800/50 px-8 py-5">
