    ...
    <section className="space-y-4 sm:space-y-6 cursor-default">
      ...
      {items.length === 0 && (
        <div className="text-center py-10 sm:py-12 text-zinc-500">
          <p className="text-base sm:text-lg mb-2">Nenhuma foto na galeria</p>
      ...
      {confirmDelete !== null && (
        <div 
          className="fixed inset-0 bg-black/80 backdrop-blur-sm flex items-end sm:items-center justify-center z-[120] p-4 animate-in fade-in duration-300"
          onClick={() => setConfirmDelete(null)}
        >
          <div 
            className="bg-zinc-900 rounded-2xl p-6 sm:p-8 w-full max-w-md border border-zinc-800 shadow-2xl animate-in slide-in-from-bottom-4 sm:zoom-in-95"
            onClick={(e) => e.stopPropagation()}
          >
            <h3 className="text-xl sm:text-2xl font-black text-white mb-3 sm:mb-4 uppercase italic tracking-tighter">Confirmar Exclusão</h3>
