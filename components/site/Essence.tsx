...
export default function Essence() {
  return (
    <section id="essencia" className="relative py-16 sm:py-32 px-4 sm:px-6 bg-zinc-950 overflow-hidden">
      <div className="absolute top-0 right-0 w-[300px] sm:w-[500px] h-[300px] sm:h-[500px] bg-gsw/5 blur-[150px] rounded-full pointer-events-none" />
      <div className="absolute bottom-0 left-0 w-[300px] sm:w-[500px] h-[300px] sm:h-[500px] bg-purple-900/5 blur-[150px] rounded-full pointer-events-none" />
      ...
      <div className="relative z-10 max-w-5xl mx-auto">
        ...
        <div className="mb-10 sm:mb-20 text-center">
          ...
          <p className="text-zinc-400 max-w-2xl mx-auto italic leading-relaxed text-sm sm:text-lg px-2">
            "O que começou como pixels e estratégias se transformou em algo que transcende qualquer tela."
          </p>
        </div>

        <div className="mb-12 sm:mb-24 space-y-4 sm:space-y-6 text-sm sm:text-lg text-zinc-300 leading-relaxed max-w-3xl mx-auto">
          <p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6 mb-12 sm:mb-24">
          <div className="group p-6 sm:p-8 rounded-2xl bg-black/40 border border-white/10 hover:border-gsw/40 transition-all duration-300 hover:-translate-y-1">
            <div className="mb-3 sm:mb-4 inline-flex p-3 rounded-xl bg-gsw/10 text-gsw">
            ...
            <h4 className="text-white font-bold mb-2 sm:mb-3 text-lg sm:text-xl tracking-tight">
              Conexões Reais
            </h4>
          ...
          <div className="group p-6 sm:p-8 rounded-2xl bg-black/40 border border-white/10 hover:border-gsw/40 transition-all duration-300 hover:-translate-y-1 sm:col-span-2 md:col-span-1">
            <div className="mb-3 sm:mb-4 inline-flex p-3 rounded-xl bg-gsw/10 text-gsw">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <div className="mb-12 sm:mb-24 space-y-4 sm:space-y-8 text-sm sm:text-lg text-zinc-300 leading-relaxed max-w-3xl mx-auto">
          <p>
