    ...
    <section id="galeria" className="relative py-32 px-6 bg-black overflow-hidden">
            ...
            {photos.map((photo, index) => (
              ...
              >
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black via-black/40 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-200 flex flex-col justify-end p-4">
                  ...
                  {photo.description && (
                    <p className="text-zinc-300 text-xs">{photo.description}</p>
                  )}
                </div>
              </div>
            ))}
      ...
      {selectedPhoto && (
        ...
        >
          ...
          <button
            className="absolute left-4 top-1/2 -translate-y-1/2 text-white/60 hover:text-white z-50 bg-black/50 rounded-full p-3 transition-transform duration-200 hover:scale-110"
          ...
          <button
            className="absolute right-4 top-1/2 -translate-y-1/2 text-white/60 hover:text-white z-50 bg-black/50 rounded-full p-3 transition-transform duration-200 hover:scale-110"
          ...
          >
            ...
            <div className="mt-8 mb-4 text-center max-w-2xl">
              ...
              {selectedPhoto.description && (
                <p className="text-zinc-400 italic text-sm">{selectedPhoto.description}</p>
              )}
            </div>
          </div>
