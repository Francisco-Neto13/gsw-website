    ...
    observerRef.current = new IntersectionObserver(
      (entries) => {
        entries.forEach((entry) => {
          const indexAttr = entry.target.getAttribute('data-photo-index');
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        {loading ? (
          <div className="flex justify-center py-20">
             <div className="animate-spin rounded-full h-12 w-12 border-t-2 border-b-2 border-gsw"></div>
          </div>
        ) : (
        ...
        <div className="mt-24 text-center reveal-on-scroll">
          <p className="text-zinc-500 italic border-t border-white/5 pt-12 inline-block px-12 leading-relaxed">
            "Onde houver uma batalha, haverá um <span className="text-gsw/60 font-bold text-sm tracking-widest uppercase">Guardião</span>. O legado da GsW é eterno."
          </p>
        </div>
      </div>
