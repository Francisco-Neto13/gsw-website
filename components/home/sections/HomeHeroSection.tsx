  ...
  return (
    <>
      ...
      >
        ...
        <div className="hero-tint absolute inset-0 z-[1]" />
        <div className="hero-fade absolute inset-x-0 bottom-0 z-[2] h-48" />

        <div className="relative z-10 mx-auto max-w-7xl -translate-y-10 text-center">
          <h1 className="hero-brand text-6xl font-black italic leading-none tracking-tight text-gsw sm:text-8xl lg:text-9xl">
